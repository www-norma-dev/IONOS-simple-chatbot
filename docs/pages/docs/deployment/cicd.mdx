...
- Add lint/test stages before build
- Integrate vulnerability scanning (Trivy, Grype)
- Blue/Green or Canary deployments
- Automated CHANGELOG generation

---
## Summary
Tagging a semantic version triggers an end-to-end build & deploy to IONOS Kubernetes using templated manifests, versioned images, and recreated secrets. Provide your kubeconfig via the `KUBE_CONFIG` secret and keep API keys rotated for security.
