...
1. **IONOS Hub (Inference Models)**: Provider/name format with slash (e.g., `mistralai/Mistral-Small-24B-Instruct`)
2. **IONOS Studio (Fine-tuned Models)**: UUID format (e.g., `7b19cae7-0983-4a6b-a03c-a647db48f00b`)
